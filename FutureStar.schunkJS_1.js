      ...
      9461: function (t, e, n) {
         ...
         i.define("brand", t.exports = function () {}, function (t) {
            ...
            return n.ready = function () {
               ...
               /\.webflow\.io$/i.test(f) && s.hostname !== f && (d = !0), d && !u && (e = e || (n = t('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs"), i = t("<img>").attr("src", "../FutureStar_images/webflow-badge-icon-d2.89e12c322e.svg").attr("alt", "").css({
                  marginRight: "4px",
                  width: "26px"
               }), a = t("<img>").attr("src", "../FutureStar_images/webflow-badge-text-d2.c82cec3b78.svg").attr("alt", "Made in Webflow"), n.append(i, a), n[0]), h(), setTimeout(h, 500), t(r).off(c, l).on(c, l))
            }, n
         })
      },
      322: function (t, e, n) {
               ...
               for (var e = document.links, a = 0; a < e.length; ++a) ! function (e) {
                  if (!e.getAttribute("hreflang")) {
                     ...
                     if (l.href = i, !(i.indexOf(":") >= 0)) {
                        ...
                        "#" !== i && "" !== i && m(a, h, !u && l.href === c.href || i === o || d.test(i) && f.test(o))
                     }
                  }
               }(e[a]);
